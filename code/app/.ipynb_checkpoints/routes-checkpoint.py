...
def dashboard():
    ...
    return render_template("dashboard.html", 
                           ...
                           daily1 = json.dumps(daily1),
                           daily2 = json.dumps(daily2),
                           daily3 = json.dumps(daily3),
                           name1 = json.dumps(name1),
                           name2 = json.dumps(name2),
                           name3 = json.dumps(name3),
                           symp1 = json.dumps(symp1),
                           symp2 = json.dumps(symp2),
                           symp3 = json.dumps(symp3),
                           ...
                           fall1 = json.dumps(fall1),
                           fall2 = json.dumps(fall2),
                           fall3 = json.dumps(fall3),
                           depr1 = json.dumps(depr1),
                           depr2 = json.dumps(depr2),
                           depr3 = json.dumps(depr3),
                           pneu1 = json.dumps(pneu1),
                           pneu2 = json.dumps(pneu2),
                           pneu3 = json.dumps(pneu3),
                           flu1 = json.dumps(flu1),
                           flu2 = json.dumps(flu2),
                           flu3 = json.dumps(flu3),
                           med1 = json.dumps(med1),
                           med2 = json.dumps(med2),
                           med3 = json.dumps(med3),
                           tmed1 = json.dumps(tmed1),
                           tmed2 = json.dumps(tmed2),
                           tmed3 = json.dumps(tmed3),
                           diab1 = json.dumps(diab1),
                           diab2 = json.dumps(diab2),
                           diab3 = json.dumps(diab3),
                           dtc1 = json.dumps(dtc1),
                           dtc2 = json.dumps(dtc2),
                           dtc3 = json.dumps(dtc3),
                           er1 = json.dumps(er1),
                           er2 = json.dumps(er2),
                           er3 = json.dumps(er3),
                           adm1 = json.dumps(adm1),
                           adm2 = json.dumps(adm2),
                           adm3 = json.dumps(adm3),
                           ppr1 = json.dumps(ppr1),
                           ppr2 = json.dumps(ppr2),
                           ppr3 = json.dumps(ppr3))
