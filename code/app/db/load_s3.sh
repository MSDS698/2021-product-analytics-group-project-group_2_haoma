...
aws s3api put-object --bucket haoma --key HH_Zip_Oct2020.csv --body HH_Zip_Oct2020.csv
echo "HH_Zip_Oct2020.csv has been uploaded to S3 bucket 'haoma'..."
...
aws s3api put-object --bucket haoma --key HH_Provider_Oct2020.csv --body HH_Provider_Oct2020.csv
echo "HH_Provider_Oct2020.csv has been uploaded to S3 bucket 'haoma'..."
